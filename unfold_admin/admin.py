...
# from django.contrib.admin import ModelAdmin  # <--- не unfold.admin.ModelAdmin
# from unfold.sites import UnfoldAdminSite
# from payments.models import Invoice, PaymentAttempt
...
# class InvoiceAdmin(ModelAdmin):  # <-- обычный ModelAdmin
#     list_display = ("id", "amount", "status")


# class PaymentAttemptAdmin(ModelAdmin):
#     list_display = ("id", "invoice", "status")


# unfold_admin_site.register(Invoice, InvoiceAdmin)
# unfold_admin_site.register(PaymentAttempt, PaymentAttemptAdmin)